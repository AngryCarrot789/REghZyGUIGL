...
public class CoordinateHelper {
    ...
    //void e(float worldX, float worldY) {
    //    int w = 500;
    //    int h = 200;
    //    float openglX = -0.5f;
    //    float openglY = -0.5f;
    ...
    //        // newX = 0.8
    //        float newX = -worldX;
    //        float actualX = w * (1 - newX);
    //    }
    //    else {
    //        // worldX = 0.8
    //        float actualX = w * worldX;
    //    }
    //    // worldY = 0.8
    //    if (worldY > 0) {
    //        // 0.2
    //        float newY = 1 - worldY;
    //        float actualY = h * newY;
    //    }
    //    // world = -0.8
    //    else {
    //        // 0.8
     ...
     * @return
     */
    public static float ndcToScreenX(float ndc, float width) {
        if (ndc < 0.0f) {
            return width * (1 - (-ndc));
        }
        else if (ndc > 0.0f) {
     ...
     * @return
     */
    public static float ndcToScreenY(float ndc, float height) {
        if (ndc < 0.0f) {
            return height * (-ndc);
        }
        else if (ndc > 0.0f) {
     ...
     */
    public static float screenToNdcX(float x, float width) {
        return ((x / width) * 2) - 1;
    }
     ...
     */
    public static float screenToNdcY(float y, float height) {
        return 1 - ((y / height) * 2);
    }
}
